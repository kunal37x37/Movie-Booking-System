...
namespace MovieBookingSystem.Migrations
{
    ...
    [Migration("20251023165928_FixedModels")]
            ...
            modelBuilder.Entity("MovieBookingSystem.Models.Showtime", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            MovieId = 1,
                            ShowDateTime = new DateTime(2025, 10, 24, 18, 30, 0, 0, DateTimeKind.Local),
                        ...
                        new
                        {
                            ...
                            IsActive = true,
                            MovieId = 2,
                            ShowDateTime = new DateTime(2025, 10, 23, 15, 0, 0, 0, DateTimeKind.Local),
                        ...
                        new
                        {
                            ...
                            IsActive = true,
                            MovieId = 3,
                            ShowDateTime = new DateTime(2025, 10, 25, 20, 0, 0, 0, DateTimeKind.Local),
            ...
            modelBuilder.Entity("MovieBookingSystem.Models.Booking", b =>
                {
                    ...
                    b.HasOne("MovieBookingSystem.Models.Showtime", null)
                        .WithMany("Bookings")
